...
for(i in 1:nrow(prod.frm)) {
  ...
  # if(!is.na(prod.frm$productSensor[i])) {
  #   cat("\n", "----------------------", fill=T)
  #   cat("\n", "**Sensor**", sep=" ", fill=T)
  #   cat("\n", prod.frm$productSensor[i], sep=" ", fill=T)
  # }

  # cat("\n", "----------------------", fill=T)
  # cat("\n", "**Coverage**", sep=" ", fill=T)
  # cat("\n", prod.frm$productStudyDescription[i], sep=" ", fill=T)
  cat("\n", "----------------------", fill=T)
  ...
  # cat("\n", prod.frm$productDesignDescription[i], sep=" ", fill=T)
  ...
  dum <- iconv(prod.frm$productDesignDescription, from="UTF-8", to="ASCII")
